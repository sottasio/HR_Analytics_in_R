...
```{r}
prediction <- predict(hr.model,as.matrix(hr.test[,-7]))

prediction <- ifelse(prediction > 0.5, 1, 0)

conf.table <- table(hr.test$left,prediction)
...
<b>Interpreting the confusion table : </b>
...
Now let's see which variables were the ones that gave the most information for our model.
...
We clearly see that "Satisfaction level" gave us the most information for the model, followed by "time spent in company" and "average monthly hours".

<br>
<br>
* This analysis, was created with Rmarkdown and RStudio and it was only made for educational and exhibitional purposes.